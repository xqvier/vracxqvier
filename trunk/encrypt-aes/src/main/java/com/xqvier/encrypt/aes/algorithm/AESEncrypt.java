...
public class AESEncrypt implements SymetricEncrypt {
	...
	public static final byte[] SUB_BYTES_TABLE = ByteUtil.toBytes(,
	...
	public AESEncrypt(int pNbRound, KeySchedule pKeySchedule) {
		...
		if (!(pKeySchedule instanceof AESKeySchedule)) {
			System.out
					.println("Warning you did not chose a AESKeySchedule for the AES Encrypt."
							+ " It will be converted but it may cause subsequent problem");
			pKeySchedule = new AESKeySchedule();
		}
	...
	private ByteMatriceWord addRoundKey(ByteMatriceWord pWord, AESKey roundKey) {
		pWord.doXOR(roundKey);
		return pWord;
	}
